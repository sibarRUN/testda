...
`,u=new l.NE({UserPoolId:"ap-northeast-2_jczobrwlq",ClientId:"e90hcf6rica8am3h81lcsuspe"}),f=()=>{const[e,t]=(0,i.useState)(!1),{scroll:o}=(0,a.g7)();(0,s.Zp)();(0,i.useEffect)((()=>{const e=new URLSearchParams(window.location.search).get("code");if(e){const t=new URLSearchParams;t.append("grant_type","authorization_code"),t.append("client_id","e90hcf6rica8am3h81lcsuspe"),t.append("code",e),t.append("redirect_uri","http://testdasibar.s3-website.ap-northeast-2.amazonaws.com/"),fetch("https://ap-northeast-2jczobrwlq.auth.ap-northeast-2.amazoncognito.com/oauth2/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:t}).then((e=>e.json())).then((e=>{if(e.id_token&&e.access_token&&e.refresh_token){const t=new l.Yw({IdToken:e.id_token}),o=new l.pD({AccessToken:e.access_token}),n=new l.c9({RefreshToken:e.refresh_token}),i=new l.p4({IdToken:t,AccessToken:o,RefreshToken:n}),a=t.payload["cognito:username"];new l.TU({Username:a,Pool:u}).setSignInUserSession(i);const s=window.location.origin+window.location.pathname;window.history.replaceState({},document.title,s)}})).catch((e=>{console.error("\ud1a0\ud070 \uad50\ud658 \uc2e4\ud328: ",e)}))}}),[]);const n=n=>{const i=document.querySelector(n);t(!e),o.scrollTo(i,{offset:"-100",duration:"500",easing:[.25,0,.35,1]})};return(0,h.jsx)(d,{click:+e,initial:{y:"-100%"},animate:{y:0},transition:{duration:.5,delay:0},children:(0,h.jsxs)(m,{drag:"y",dragConstraints:{top:0,bottom:70},dragElastic:.05,dragSnapToOrigin:!0,children:[(0,h.jsx)(p,{onClick:()=>t(!e),children:(0,h.jsx)("span",{children:"MENU"})}),(0,h.jsx)(w,{whileHover:{scale:1.1,y:-5},whileTap:{scale:.9,y:0},onClick:()=>n("#home"),children:(0,h.jsx)(c.N_,{to:"/",children:"Home"})}),(0,h.jsx)(w,{whileHover:{scale:1.1,y:-5},whileTap:{scale:.9,y:0},onClick:()=>n(".about"),children:(0,h.jsx)(c.N_,{to:"/",children:"About"})}),(0,h.jsx)(w,{whileHover:{scale:1.1,y:-5},whileTap:{scale:.9,y:0},onClick:()=>n("#shop"),children:(0,h.jsx)(c.N_,{to:"/",children:"Shop"})}),(0,h.jsx)(w,{whileHover:{scale:1.1,y:-5},whileTap:{scale:.9,y:0},onClick:()=>window.location.href="https://ap-northeast-2jczobrwlq.auth.ap-northeast-2.amazoncognito.com/login?client_id=e90hcf6rica8am3h81lcsuspe&response_type=code&scope=email+openid&redirect_uri=https%3A%2F%2Fd2c37b9hnb6ap4.cloudfront.net",children:(0,h.jsx)(c.N_,{to:"#",children:"Login / Register"})}),(0,h.jsx)(w,{whileHover:{scale:1.1,y:-5},whileTap:{scale:.9,y:0},onClick:e=>{e.preventDefault();const t=u.getCurrentUser();t?t.getSession(((e,t)=>{e||!t.isValid()?(alert("\uc798\ubabb\ub41c \uc811\uadfc\uc785\ub2c8\ub2e4. \ub85c\uadf8\uc778\ud574\uc8fc\uc138\uc694."),window.location.href="https://ap-northeast-2jczobrwlq.auth.ap-northeast-2.amazoncognito.com/login?client_id=e90hcf6rica8am3h81lcsuspe&response_type=code&scope=email+openid&redirect_uri=https%3A%2F%2Fd2c37b9hnb6ap4.cloudfront.net"):window.location.href="http://testdasibar.s3-website.ap-northeast-2.amazonaws.com"})):(alert("\ubd09\uc9c0\ub2c8\ub294 \ub85c\uadf8\uc778 \ud6c4 \uc0ac\uc6a9\ud558\uc2e4 \uc218 \uc788\uc2b5\ub2c8\ub2e4."),window.location.href="https://ap-northeast-2jczobrwlq.auth.ap-northeast-2.amazoncognito.com/login?client_id=e90hcf6rica8am3h81lcsuspe&response_type=code&scope=email+openid&redirect_uri=https%3A%2F%2Fd2c37b9hnb6ap4.cloudfront.net")},children:(0,h.jsx)(c.N_,{to:"#",children:"BonGenie"})})]})})}}}]);